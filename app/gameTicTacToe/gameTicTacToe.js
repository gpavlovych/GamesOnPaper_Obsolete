...
angular.module('myApp.gameTicTacToe', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/gameTicTacToe', {
            templateUrl: 'gameTicTacToe/gameTicTacToe.html',
            controller: 'GameTicTacToeCtrl'
        });
    }])
    ...
    .controller('GameTicTacToeCtrl', ['$scope', function($scope) {
